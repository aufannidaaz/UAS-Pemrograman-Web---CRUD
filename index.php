...
if (isset($_POST['no_kendaraan'])) {
	...
	$x = query("INSERT INTO tbl_kendaraan (id_kendaraan,no_kendaraan,jenis_kendaraan,jam_masuk,jam_keluar,status) VALUES ('','$no_kendaraan','$jenis_kendaraan','$jam_masuk','','belum selesai') ");
	if ($x) {
